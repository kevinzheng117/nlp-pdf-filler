...
// Load the original PDF template from bundled location
async function loadPDFTemplate() {
  try {
    ...
    console.error('Error loading bundled PDF template:', error);
    throw new Error('Failed to load bundled PDF template');
  }
}
